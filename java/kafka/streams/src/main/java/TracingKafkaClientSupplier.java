...
public class TracingKafkaClientSupplier {
    ...
    public static void main(String[] args) {
        TracingKafkaClientSupplier tracing = new TracingKafkaClientSupplier();
        tracing.loadConfiguration(System.getenv());
        Properties props = tracing.loadKafkaStreamsProperties();
